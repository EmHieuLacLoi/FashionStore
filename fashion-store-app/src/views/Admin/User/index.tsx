...
import { useGetList, useDeleteMutation } from "@hooks/UserHooks";
...
const UserView = () => {
  ...
  const [dataResult, setDataResult] = useState<User[]>([]);
  ...
  const handleEditData = (record: User) => {
    setCurrentDetailData(record);
    setActionType("update");
    setShowModalCreate(true);
  };

  const handleDeleteData = (record: User) => {
    setCurrentDetailData(record);
